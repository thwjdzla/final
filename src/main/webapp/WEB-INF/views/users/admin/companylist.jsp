...
<%@ include file="../../include/mypagenav.jsp" %>
	<div class="container" style="font-family: '맑은 고딕';">
		...
		<ul class="nav nav-pills nav-justified">
		  <li><a href="customerlist.do" style="background-color: white; color: #e87a92 !important; font-weight: bold;">일반 고객</a></li>
		  <li class="active" style="background-color: white; font-weight: bold;"><a href="companylist.do">업체 고객</a></li>
		</ul>
