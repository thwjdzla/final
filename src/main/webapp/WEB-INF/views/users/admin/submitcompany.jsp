...
<%@ include file="../../include/mypagenav.jsp" %>
	<div class="container" style="font-family: '맑은 고딕';  width: 1216px !important;">
		...
		<ul class="nav nav-pills nav-justified">
		  <li><a href="companyadmin.do" style="color: #e87a92 !important; font-weight: bold; background-color: white;">모든 업체 리스트</a></li>
		  <li class="active" style="font-weight: bold; background-color: white;"><a href="sbcompany.do">신청 업체 리스트</a></li>
