	...
	<div class="contWrap">
		...
		<div class="w3-container" style="padding: 0;">
			<ul class="nav nav-pills nav-justified" role="tablist">
				<li>STEP1. 본인확인</li>
				<li>STEP2. 약관동의</li>
				<li  class="active">STEP3. 개인정보 입력</li>
				<li>STEP4. 가입 완료</li>
			</ul>
		</div>
				...
				<table class="tb-1 tbData" style="margin: 35px auto; width: 100%;">
					...
					<tbody>
						<tr>
							...
							<td class="fm">
								<span class="radG fmMgL">
									<span class="radFm">
										<input type="radio" class="rad" id="type1" name="type" value="C">
										<span class="act"></span>
										<label for="type1"  style="margin: 0;">업체</label>
									</span>
									<span class="radFm">
										<input type="radio" class="rad" id="type2" name="type" value="U" checked="checked">
										<span class="act"></span>
						...
						<tr>
							...
							<td class="fm">
								<input type="text" class="ipt fw-1" placeholder="성" title="성" id="nameLast" name="nameLast" maxlength="2">
								<input type="text" class="ipt fw-2" placeholder="이름" title="이름" id="nameFirst" name="nameFirst" maxlength="5">
								<span class="radG fmMgL">
									<span class="radFm">
										<input type="radio" class="rad" id="sexcode1" name="sexcode" value="M" checked="checked">
										<span class="act"></span>
						...
						<tr>
							...
							<td class="fm">
								<input type="text" class="ipt fw-24" title="아이디" id="id" name="id" maxlength="20">
								<a id="idck" class="btnD btn-4 fmBtn">중복검사</a>
						...
						<tr>
							...
							<td class="fm">
								<input type="text" class="ipt fw-5" title="이메일" id="emailid" name="emailid" maxlength="30" value="${emailid }" readonly="readonly"/>
								<span class="fmTxt-3">@</span>
								<input type="text" class="ipt fw-5" title="E-mail 도메인" id="emailDomain" name="emailDomain" maxlength="30" value="${emailDomain }" readonly="readonly"/>
								<!-- <select class="slt fw-6" title="직접입력" onchange="" id="email_domain_sel" name="email_domain_sel" disabled="disabled">
						...
						<tr>
							...
							<td class="fm">
								...
								<a href="#zip_1" class="btnD btn-4 fmBtn" onclick="sample6_execDaumPostcode()">우편번호검색</a>
								<input type="text" class="ipt fw-8 fmMg-1" title="주소" id="address1" name="address1" maxlength="100"/>
								<input type="text" class="ipt fw-8 fmMg-1" title="상세주소" id="address2" name="address2" maxlength="100" onkeyup=""/>
							</td>
						</tr>
						<tr>
...
$(function() {
	$("#insertForm").submit(function(event) {
		...
		var telno3 = $("#zip").val().trim();
		var telno3 = $("#address1").val().trim();
		var telno3 = $("#address2").val().trim();
