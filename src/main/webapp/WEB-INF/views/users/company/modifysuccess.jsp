...
<div id="container ct" class="contBg" style="font-family: '맑은 고딕';">
	<div class="contWrap">
		...
		<div class="pagTitSub" style="text-align: center; margin-bottom: 25px;">
			수정이 완료되었습니다.
			<br>업체 등록과 다르게 수정된 내용은 바로 적용됩니다.
		</div>
		<div class="w3-container" style="padding: 0;">
			<ul class="nav nav-pills nav-justified" role="tablist">
				<li>STEP1. 정보수정</li>
				<li class="active">STEP2. 수정완료</li>
			</ul>
		</div>
		<div class="contBox">
			<h3 class="title-6 aC first">수정이 완료되었습니다!<br>${LOGIN_USER.name } 님 변경된 내용은 마이페이지에서 확인할 수 있습니다.</h3>
			<div class="w3-container" style="padding: 0; margin-top: 30px;">
			<ul class="nav nav-pills nav-justified" role="tablist">
				<li class="contBox">
					<h3 class="title-1 fs-16 aC">
						<span style="color: #e87a92 !important; font-weight: bold;">마이페이지</span><br><br>이 곳에서 업체 내역을 확인 하실 수 있습니다.<br>　
					</h3>
