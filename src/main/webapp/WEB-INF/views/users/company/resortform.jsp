...
.nav-pills>li {
  ...
  $(function() {
	  $("#resortForm").submit(function(event) {
			...
			var tel1 = $("#resortTelNo1").val().trim();
			var tel2 = $("#resortTelNo2").val().trim();
			var tel3 = $("#resortTelNo3").val().trim();
				...
				<table class="tb-1 tbData" style="margin: 35px auto; width: 100%;">
					...
					<tbody>
						<tr>
							...
							<td class="fm">
								<input type="text" class="ipt fw-24" title="업체명" id="resort_name" name="resortName" maxlength="20">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<input type="text" class="ipt fw-24" title="이름" id="resort_owner" name="resortOwner" maxlength="20">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<textarea type="text" rows="5" cols="50" title="소개" id="resort_content" name="resortContent" maxlength="1000"></textarea>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<input type="file" title="대표이미지" id="resort_img" name="resortImg">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<select class="slt fw-3" title="연락처 앞자리" id=resortTelNo1 name="resortTelNo1">
								...
								<input type="text" class="ipt fw-3" title="연락처 중간자리" id="resortTelNo2" name="resortTelNo2" value="" maxlength="4" />
								<span class="fmTxt-3">-</span>
								<input type="text" class="ipt fw-3" title="연락처 끝자리" id="resortTelNo3" name="resortTelNo3" value="" maxlength="4"/>
							</td>
						</tr>
						<tr>
							<th scope="row">
