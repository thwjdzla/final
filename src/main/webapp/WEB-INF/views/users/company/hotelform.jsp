				...
				<table class="tb-1 tbData" style="margin: 35px auto; width: 100%;">
					...
					<tbody>
						<tr>
							...
							<td class="fm">
								<input type="text" class="ipt fw-24" title="업체명" id="hotel_name" name="hotelName" maxlength="20">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<input type="text" class="ipt fw-24" title="이름" id="hotel_owner" name="hotelOwner" maxlength="20">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<textarea type="text" rows="5" cols="50" title="소개" id="hotel_content" name="hotelContent" maxlength="1000"></textarea>
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<input type="file" title="대표이미지" id="hotel_img" name="hotelImg">
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td class="fm">
								<input type="number" class="ipt fw-1" placeholder="1~5" title="등급" id="hotel_star" name="hotelStar" min="1" max="5">
							</td>
						</tr>
						<tr>
							<th scope="row">
