	...
	<div class="contWrap">
		...
		<div class="w3-container" style="padding: 0;">
			<ul class="nav nav-pills nav-justified" role="tablist">
				<li  class="active" style="padding: 0 !important;"><a href="question.do" style="padding: 10px 15px !important;">업체문의</a></li>
				<li style="padding: 0 !important;"><a href="adminQuestion.do" style="padding: 10px 15px !important; color: #e87a92 !important;">관리자문의</a></li>
				<li style="padding: 0 !important;"><a href="FAQ.do" style="padding: 10px 15px !important; color: #e87a92 !important;">FAQ</a></li>
			</ul>
		</div>
		<form id="submitQuestion" name="submitQuestion" method="post" action="submitQuestion.do" enctype="multipart/form-data">
			<div class="contBox">
			<div class="cHead chw-3 first">
				<h4 class="title-3 fc-1 chwTit">업체문의</h4>
					...
					<tbody>
						<tr>
							...
							<td class="fm" colspan="3">
								<input type="text" class="ipt fw-32" id="title" name="title" title="제목" maxlength="200" placeholder="제목을 입력해 주세요." style="width: 858px;">
							</td>
						</tr>
						<tr>
							<th scope="row">업체</th>
							<td class="fm">
								<select class="slt fw-25" id="cpNo" name="cpNo" title="호텔">
									<option value="">선택하세요.</option>
								<c:forEach var="company" items="${companys }">
									<option value="${company.cpNo }">${company.cpName }</option>
								</c:forEach>
								</select>
							</td>
							<th scope="row">유형</th>
							<td class="fm">
								<select class="slt fw-25" id="type" name="type" title="유형">
									<option value="">선택하세요.</option>
				...
				<table class="tb-1 tbData single cmg-4" style="width: 100%;">
					...
					<tbody>
						<tr>
							<th scope="row">이름</th>
							<td class="fm">
								<input type="text" class="ipt fw-1" placeholder="성" title="성" name="lastName" id="nm_last" maxlength="2">
								<input type="text" class="ipt fw-2" placeholder="이름" title="이름" name="firstName" id="nm_first" maxlength="5">
							</td>
							<th scope="row">연락처</th>
							<td class="fm">
						...
						<tr>
							...
							<td colspan="3" class="fm">
								<input type="text" class="ipt fw-5" title="E-mail 주소" id="email" name="emailid" maxlength="30">
								<span class="fmTxt-3">@</span>
								<input type="text" class="ipt fw-5" title="E-mail 도메인" id="email_domain" name="emailDomain" maxlength="30">
