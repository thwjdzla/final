	...
	<div class="contWrap">
		...
		<div class="contBox">
			<c:choose>
				...
				<form id="addAnswerForm" name="addAnswerForm" method="post" action="addCompanyAnswer.do" enctype="multipart/form-data">
					<input type="hidden" name="questionNo" value="${question.no }">
					<input type="hidden" name="cpNo" value="${question.cpNo }">
									...
									<tr>
										...
										<td style="text-align: center;">
											<c:if test="${question.status == '미답변' }">
												<span class="qstatus" style="background-color: Gray !important;border-color: #e87a92;padding: 8px 40px;color: #fff;font-size: 14px;border-radius: 0.25em;">${question.status }</span>
											</c:if>
											<c:if test="${question.status == '답변완료' }">
												<span class="qstatus" style="background-color: #e87a92 !important;border-color: #e87a92;padding: 8px 40px;color: #fff;font-size: 14px;border-radius: 0.25em;">${question.status }</span>
											</c:if>
								  		</td>
								  	</tr>
									<tr>
										<td style="text-align: center; font-weight: bold; background: #fafafa;">내용</td>
										<td colspan="3">${question.contentsWithBr }</td>
								  	</tr>
								</c:if>	
							</tbody>
						</table>
							...
							<c:if test="${not empty answer }">
								...
								<tbody>
									<tr>
								  	...
								  	<tr>
										<td colspan="3">${answer.contentsWithBr }</td>
							  		</tr>
								</tbody>
							</c:if>	
						</table>
